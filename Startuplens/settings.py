"""
Django settings for Startuplens project.
...
INSTALLED_APPS = [
    ...
    'startup_ideas.apps.StartupIdeasConfig',
...
WSGI_APPLICATION = 'Startuplens.wsgi.application'
